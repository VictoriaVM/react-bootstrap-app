        ...
        return <div>
            <div className={styles.tabs}>
                <div className={classNames({ [styles.active]: activeTabName === 'tab1' })} onClick={this.handleTabClick('tab1')}>
                    <div><img className={styles.tab_one_icon} src="http://cdn.onlinewebfonts.com/svg/img_33853.png"/></div>
                    <span>публикации</span>
                </div>
                <div className={classNames(styles.marg, { [styles.active]: activeTabName === 'tab2' })} onClick={this.handleTabClick('tab2')}>
                    <div><img className={styles.tab_two_icon} src="http://cdn.onlinewebfonts.com/svg/img_266351.png"/></div>
                    <span>отметки</span>
                </div>
            </div>
            { activeTabName === 'tab1'
                ...
                : <div className={styles.photo_row}>
                    { photoTaggedData.map((photoPostData, i) =>
                        <PhotoPosts key={i} url={photoPostData.url} likes={photoPostData.likes} comments={photoPostData.comments} />) }
                </div>}
        </div>;
    }
